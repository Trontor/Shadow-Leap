 ...
 * @author Rohyl Joshi
 */
public class MovingObstacle extends Sprite implements TimeSupport, Collidable {
	 ...
	 */
	public MovingObstacle(World world, String obstacleName, String imageSrc, Position centerPos, Velocity speedInfo) throws SlickException {
